        ...
        {isAuthenticated ? (
          ...
          >
            {selectedPage === "Peliculas" ? (
              ...
              <>
                <GenresForm isOpen={isOpen} onClose={onClose} onOpen={onOpen} refetch = {refetchGenres} />
                <AdminPanel
                  key="genres"
                  options={_genres}
                  handleAction={() => {
              ...
              <>
                <UsersForm isOpen={isOpen} onClose={onClose} onOpen={onOpen} refetch = {refetchUsers}/>
                <AdminPanel
                  key="users"
                  options={_users}
                  handleAction={() => {
